					...
					testMetadata.Assert(
						...
						[]*annotation.Instance{
							annotation.New(
								...
								id,
								nil,
								metadata.New(prov, idSignature, dataSignature, publicKey, s.Metadata()),
							),
							annotation.New(
								test.FactoryRandomString(),
								id,
					...
					testMetadata.Assert(
						...
						[]*annotation.Instance{
							annotation.New(
								...
								id2,
								id1,
								metadata.New(prov, idSignature2, dataSignature2, publicKey, s.Metadata()),
							),
							annotation.New(
								test.FactoryRandomString(),
								id1,
								nil,
								metadata.New(prov, idSignature1, dataSignature1, publicKey, s.Metadata()),
							),
						},
					...
					testMetadata.Assert(
						...
						[]*annotation.Instance{
							annotation.New(
								...
								id3,
								id2,
								metadata.New(prov, idSignature3, dataSignature3, publicKey, s.Metadata()),
							),
							annotation.New(
								test.FactoryRandomString(),
								id2,
