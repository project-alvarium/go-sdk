...
The SDK defines an [annotation store abstraction](.../annotation/store/contract.go) and includes an [in-process, in-memory implementation](../store/memory/store.go) to facilitate the example code.
